import { getFavoriteMovies, getFavoriteTvSeries, getRatedTotal, getWatchlist, getFavoriteActors } from '@/lib/requests/user'
...
const Stats = async () => {
    ...
    const favoriteActorsCount = (await getFavoriteActors()).length
