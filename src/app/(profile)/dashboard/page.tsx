...
const Dashboard = async () => {
    ...
    const upcomingMoviesFromWatchlist = await getUpcomingMoviesFromWatchlist()
    const upcomingTvSeriesFromWatchlist = await getUpcomingTvSeriesFromWatchlist()
    console.log(upcomingTvSeriesFromWatchlist)
    ...
    return (
        <div>
            ...
            <MediaDisplay headerTitle='Upcoming from watchlist' movies={upcomingMoviesFromWatchlist} tvSeries={recentFavoriteTvSeries} userProfile={true} isQuickView={false} cardWidth='16rem'/>
        </div>
    );
};
